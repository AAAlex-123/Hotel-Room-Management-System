...
export default function ClientMenu() {
  ...
  async function handleAbsence() {
    await fetch(`${url}/client/absence/`, { headers: { authorization: `Bearer ${token}`, "Content-type": "application/json" }, method: "POST", body: JSON.stringify({ reservation_id, state: !room?.cleanable }) })
    push(`/client/menu?room_id=${room_id}`)
  }

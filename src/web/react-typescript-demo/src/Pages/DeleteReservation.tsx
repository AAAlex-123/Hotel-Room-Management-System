...
const DeleteReservation: React.FC = () => {
  ...
  const handleSearch = (searchQuery: string) => {
    ...
    //temporary content. The search bar works based on...Reservation ID or what? You decide idk. Also I've made an oops with the checkout button because it's called By Details so I'll
